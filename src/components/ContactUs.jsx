...
const ContactUs = () => {
  return (
    <Layout>
      <main className=" mt-10 laptop:mt-14 advantage py-8 laptop:py-14   px-8 laptop:px-48 flex laptop:flex-row flex-col justify-between gap-8 laptop:gap-0  ">
        <section className="flex flex-col gap-9">
          <div className="flex flex-col gap-4">
            <p className="font-extrabold text-5xl font-sans">Get In Touch!</p>
